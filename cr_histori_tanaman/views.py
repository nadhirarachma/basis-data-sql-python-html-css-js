...
def formProduksiTanaman(request):
    ...
    if request.session.has_key('email'):
        ...
        try:
            if (request.session['role'] == ['admin']):
                role = "admin"
                return render(request, 'buat_histori_pmakanan.html', {"form" : FormProduksiTanaman, "role" : role})
                ...
                return render(request, 'buat_histori_pmakanan.html', {"form" : FormProduksiTanaman, "role" : role, "result" : result})
